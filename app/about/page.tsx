...
export default function Page() {
  return (
    <ContentShell title="소개" desc="10-eok이 무엇이고, 누가 무엇을 위해 만들었는지" crumb="소개" byline>
      <p>
      ...
      <h2>누가 만들었나</h2>
      <p>
        10-eok은 <strong>{AUTHOR}</strong>(개발자이자 개인 투자자)가 만들고 운영합니다. 금융사나 자문업체가
        아니라, "과거에 이렇게 모았으면 어땠을까?"가 직접 궁금해서 실제 데이터로 검증해 보려고 만든 개인
        프로젝트입니다. 그래서 결과를 부풀리기보다, 가정과 한계, 환율·세금 같은 현실 요소를 최대한 솔직하게
